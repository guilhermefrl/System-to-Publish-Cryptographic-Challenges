...
<div class="bg-white mt-0" id="teste"> <!--Menu Principal -->
  <ul class="nav nav-pills">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="/SI/hash/descobrir.php">Descobrir mensagens Hash</a>
    </li>
    <li class="nav-item">
...
<?php
      $sql = "SELECT * FROM desafio_hash;"; //Pesquisa todas as noticias que são definidas como visiveis
          ...
          echo "
           ...
           <div class=\"card-body\">
            <h5 class=\"card-title\"><strong>Modo de Cifra Hash: ".$row['tipo_cifra']." </strong></h5>
             ...
             <form action=\"/SI/hash/calcular.php\" method=\"POST\">
              <div class=\"mr-2 ml-2\">
              <label><h4>Mensagem</h4></label>                <!-- Campo para a mensagem -->
             ...
             <div class=\"w-5 mt-2 ml-2 mb-2\">
              ...
              <button type=\"submit\" class=\"btn btn-info\" name=\"decifrar_hash\">
                Resolver </button>
               </form>
