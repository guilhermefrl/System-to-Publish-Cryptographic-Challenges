...
<div class="bg-white mt-0" id="teste"> <!--Menu Principal -->
  <ul class="nav nav-pills">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="/SI/hash/index.php">Adicionar mensagens Hash</a>
    </li>
    <li class="nav-item">
...
<div class="row">
  <div class="card mx-auto w-75 p-5">
    <h2>Desafio de Hash</h2>
    <hr class="my-4">
    <form action="/SI/hash/hash.php" method="POST">
      <div class="card-body text-center">
        ...
        <div style="margin-left: 26.5%; margin-top: 1%; width: 80%;">
          ...
          <div class="form-row">
            <div class="col-md-7 mb-3">
              <label><h5>Função de Hash</h5></label>
              <select name="cifra" class="form-control">            <!-- Spinner para escolher a funcao de hash -->
              <option value="DFLT">Seleciona uma Opção</option>
        ...
        <button class="btn btn-primary" name="cifrar_mensagem" type="submit">Submeter Desafio Hash</button>   <!-- Botão para submeter o desafio -->
      </div>
    </form>
  </div>
</div>
...
<?php
  ...
  if(isset($_GET['error1'])){      //Mensagem de erro
    echo '<script type="text/javascript"> window.onload = function(){ if(!alert("Por favor escolha um metodo de hash")) document.location = "/SI/hash/index.php";}</script>';
  }  
?>
